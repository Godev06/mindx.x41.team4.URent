...
function buildProductMeta(product: any, userLocation: { lat: number; lng: number } | null): ProductMeta {
  ...
  return {
    locationVi: product.locationText || product.location || "Chưa cập nhật",
    locationEn: product.locationText || product.location || "Unknown",
    distanceKm: distance,
...
export function ProductListingPage({
  ...
  useEffect(() => {
    if (initializedPriceRef.current || dataMinPriceVnd === 0) return;

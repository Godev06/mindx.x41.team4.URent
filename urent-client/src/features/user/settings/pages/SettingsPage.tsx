              ...
              <div className={`${cardClass} flex flex-col justify-between`}>
                ...
                <div className="mt-6 space-y-3">
                  <div className="rounded-2xl border border-slate-200/80 bg-slate-50/80 px-4 py-4 dark:border-slate-700/80 dark:bg-slate-900/50">
                    ...
                    >
                      {twoFactorEnabled
                        ? t.settingsSecurityLevelHigh
                        : t.settingsSecurityLevelMedium}
                    </p>
                    <p className={`mt-1 text-sm leading-6 ${mutedText}`}>
                      {t.settingsSecurityStrengthDesc}
                    </p>
                  ...
                  <div className="rounded-2xl border border-slate-200/80 bg-slate-50/80 px-4 py-4 dark:border-slate-700/80 dark:bg-slate-900/50">
                    ...
                    >
                      {twoFactorEnabled
                        ? t.settingsSecurityStatusProtected
                        : t.settingsSecurityStatusWarning}
                    </p>
                    <p className={`mt-1 text-sm leading-6 ${mutedText}`}>
                      {twoFactorEnabled
                        ? t.settingsSecurityStatusDescProtected
                        : t.settingsSecurityStatusDescWarning}
                    </p>
                  </div>
                </div>
              </div>

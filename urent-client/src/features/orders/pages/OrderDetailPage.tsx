    ...
    <div className="space-y-5 pb-10">
      ...
      <div className="rounded-2xl border border-slate-200/90 bg-white p-5 shadow-sm ring-1 ring-slate-900/4 sm:p-6">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div>
            <h1 className="text-2xl font-bold tracking-tight text-slate-900">Chi tiết đơn hàng</h1>
            <p className="mt-1 text-sm text-slate-500">
              Quản lý và theo dõi quá trình mượn/trả thiết bị học tập của bạn.
            </p>
          </div>
          <div className="text-right">
            <p className="text-[10px] font-semibold uppercase tracking-wider text-slate-400">Trạng thái hiện tại</p>
      ...
      <section className="rounded-2xl border border-slate-200/90 bg-white p-5 shadow-sm ring-1 ring-slate-900/4">
        <div className="grid grid-cols-4 gap-2">
          ...
          <div className="text-center">
            ...
            <p className="text-[11px] font-medium text-slate-500">Đã hoàn tất</p>
      ...
      <section className="grid gap-5 xl:grid-cols-12">
        <article className="rounded-2xl border border-slate-200/90 bg-white p-5 shadow-sm ring-1 ring-slate-900/4 xl:col-span-8">
          <h2 className="text-lg font-semibold text-slate-900">Xác nhận giao nhận</h2>
          <p className="mt-1 text-sm text-slate-500">
        ...
        <aside className="space-y-4 xl:col-span-4">
          ...
          <div className="rounded-2xl border border-slate-200/90 bg-white p-5 shadow-sm ring-1 ring-slate-900/4">
            <div className="flex items-center justify-between">
              <h3 className="text-sm font-semibold text-slate-900">Hỗ trợ khách hàng</h3>
            ...
            <div className="mt-3 rounded-xl border border-slate-200 bg-slate-50/70 p-3">
              <p className="text-xs font-medium text-slate-700">Phản hồi trung bình dưới 2 phút</p>
              <p className="mt-1 text-[11px] text-slate-500">Nếu có sự cố QR, đội hỗ trợ sẽ ưu tiên xử lý ngay trong phiên giao nhận.</p>
            </div>
            ...
            <div className="mt-3 space-y-2">
              ...
              >
                ...
                <div>
                  <p className="text-xs font-semibold text-slate-800">Chat với Chuyên gia</p>
                  <p className="text-[11px] text-slate-500">Trao đổi trực tiếp để xử lý ngay tại điểm hẹn</p>
                </div>
              </button>
              <button
                type="button"
              ...
              >
                ...
                <div>
                  <p className="text-xs font-semibold text-slate-800">Trung tâm hỗ trợ</p>
                  <p className="text-[11px] text-slate-500">Hướng dẫn quét mã, xác minh danh tính và chính sách</p>
                </div>
              </button>
              <button
                type="button"
              ...
              >
                ...
                <div>
                  <p className="text-xs font-semibold text-amber-700">Báo cáo vi phạm</p>
                  <p className="text-[11px] text-amber-700/80">Sản phẩm lỗi, không đúng mô tả hoặc nghi ngờ gian lận</p>
                </div>
              </button>
            </div>
          </div>
      ...
      <section className="grid gap-5 xl:grid-cols-12">
          ...
          <div className="grid gap-4 md:grid-cols-[1fr_1.2fr]">
            <div className="rounded-xl border border-slate-200 p-3">
              <div className="flex gap-3">
                <div className="h-14 w-14 overflow-hidden rounded-lg bg-slate-100">
                  {order.imageUrl ? (
                    ...
                    <div className="flex h-full items-center justify-center text-xl">{order.image}</div>
                  )}
                </div>
                <div>
                  <Badge variant="blue">Auctionbay</Badge>
                  <p className="mt-1 text-sm font-semibold text-slate-900">{order.name}</p>
                  <p className="text-xs text-slate-500">Chủ sở hữu: Hoàng Nam</p>
                </div>
              </div>
              <dl className="mt-4 space-y-1 text-xs text-slate-600">
                ...
                <div className="flex justify-between">
                  <dt>Ngày bắt đầu</dt>
                  <dd className="font-medium text-slate-800">12/10/2024</dd>
                </div>
                <div className="flex justify-between">
                  <dt>Ngày hết hạn</dt>
                  <dd className="font-medium text-slate-800">19/10/2024</dd>
                </div>
              </dl>
            </div>

            <div className="rounded-xl border border-slate-200 p-3">
              <h4 className="text-sm font-semibold text-slate-900">Chi tiết thanh toán</h4>
              <dl className="mt-3 space-y-2 text-xs text-slate-600">
                <div className="flex justify-between">
                  <dt>Giá thuê (195k/ngày)</dt>
                  <dd>175,000đ</dd>
                </div>
                <div className="flex justify-between">
                  <dt>Phí dịch vụ</dt>
              ...
              <div className="mt-3 flex items-center justify-between border-t border-slate-200 pt-3">
                ...
                <span className="text-xl font-bold text-teal-600">1,390,000đ</span>
              </div>
            </div>
          </div>
        </article>
        ...
        <aside className="rounded-2xl border border-slate-200/90 bg-white p-3 shadow-sm ring-1 ring-slate-900/4 xl:col-span-4">
          <div className="flex h-full min-h-[220px] flex-col overflow-hidden rounded-xl bg-slate-100">
            <div className="flex flex-1 items-center justify-center">
              <MapPin size={84} className="text-slate-400" />
            </div>
            <div className="border-t border-slate-200 bg-white px-3 py-2">
              <p className="text-[10px] uppercase tracking-wide text-slate-400">Địa điểm giao nhận</p>
              <p className="text-xs font-medium text-slate-700">Thư viện Trung tâm - Khu phố 6, Linh Trung</p>
            </div>
          </div>
        </aside>
      </section>

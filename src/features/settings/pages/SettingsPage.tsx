          ...
          {activeTab === "preferences" && (
            <div className="grid gap-4 xl:grid-cols-2">
              ...
              <div className={`${cardClass} flex flex-col`}>
                ...
                <div className="mt-6 rounded-2xl border border-slate-200/80 bg-slate-50/80 p-4 dark:border-slate-700/80 dark:bg-slate-900/50">
                  ...
                  <div className="mt-4 grid gap-3 sm:grid-cols-2">
                    <div className="rounded-2xl border border-slate-200/80 bg-white px-4 py-3 dark:border-slate-700/80 dark:bg-slate-800">
                      <p
                        className={`text-[11px] font-semibold uppercase tracking-[0.18em] ${mutedText}`}
                      >
                        Active

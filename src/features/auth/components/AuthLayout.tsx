              ...
              >
                ...
                <div className="mb-6 flex items-center justify-between">
                  ...
                  <button
                    type="button"
                    onClick={toggleLang}
                    className={`rounded-full border px-3 py-1 text-xs font-semibold text-[#00bfa5] transition-colors ${
                      theme === "dark"
                        ? "border-[#00bfa5]/30 hover:bg-[#00bfa5]/10"
                        : "border-[#00bfa5]/20 bg-[#00bfa5]/5 hover:bg-[#00bfa5]/10"
                    }`}
                  >
                    {t.langToggle}
                  </button>
